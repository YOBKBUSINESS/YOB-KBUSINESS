...
Future<Response> _onGet(RequestContext context) async {
  try {
    ...
    final result = await repo.findAll(
      ...
      certificationIssued: params['certification'] == 'true'
          ? true
          : params['certification'] == 'false'
              ? false
              : null,
    );
...
Future<Response> _onPost(RequestContext context) async {
  try {
    ...
    if (body['title'] == null || body['location'] == null) {
      return Response.json(
        statusCode: 400,
        body: {
          'success': false,
          'message': 'Titre et lieu sont requis',
        },
      );
    }

    final training = await repo.create(body);
    return Response.json(
      statusCode: 201,
      body: {'success': true, 'data': training},
    );
  } catch (e) {
    return Response.json(
      statusCode: 500,
