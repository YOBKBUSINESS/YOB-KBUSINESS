...
Future<Response> _onGet(RequestContext context) async {
  try {
    final repo = context.read<BoreholeRepository>();
...
Future<Response> _onPost(RequestContext context) async {
  try {
    ...
    if (body['name'] == null || body['contractor'] == null) {
      return Response.json(
        statusCode: 400,
        body: {
          'success': false,
          'message': 'Nom et prestataire sont requis',
        },
      );
    }

    final borehole = await repo.create(body);
    return Response.json(
      statusCode: 201,
      body: {'success': true, 'data': borehole},
    );
  } catch (e) {
    return Response.json(
      statusCode: 500,
